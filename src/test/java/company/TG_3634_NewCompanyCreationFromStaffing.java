...
public class TG_3634_NewCompanyCreationFromStaffing extends TestBase {
	...
	public void Tag_VerifyCompanyTypeAndCompanyNameAreAMandatoryFieldsStaffing(String url, String username, String password,
	...
	public Object[][] data() throws IOException, ParserConfigurationException, SAXException {
		...
		return reader.testData("TG_AddNewCompanyStaffing"); // data tag from XML
	}
