...
public class TG_5748_Exclusive_Hiring_Company_Creation_Via_Staffing extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(TG_5748_Exclusive_Hiring_Company_Creation_Via_Staffing.class.getName());
	...
	@Test(dataProvider = "TG_5748_Exclusive_Hiring_Company_Creation_Via_Staffing")
	public void TG_5461_VerifyUserIsAbleToRouteToLeadFormSuccessfully(String url, String username, String password, String firstName,
			String lastName, String companyName, String email, String phoneNumber, String address,
	...
	@DataProvider(name = "TG_5748_Exclusive_Hiring_Company_Creation_Via_Staffing")
	public Object[][] data1() throws IOException, ParserConfigurationException, SAXException {
		XmlReader reader = new XmlReader();
		return reader.testData("TG_5748_Exclusive_Hiring_Company_Creation_Via_Staffing"); // data tag from XML
	}
