...
public class TG_5558_Staffing_Company_Creation_Via_TAG extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(TG_5558_Staffing_Company_Creation_Via_TAG.class.getName());
	...
	@Test(dataProvider = "TG_5558_Staffing_Company_Creation_Via_TAG")
	public void TG_5461_VerifyUserIsAbleToRouteToLeadFormSuccessfully(String url, String username, String password, String firstName,
			...
			String notes, String startDate, String endDate, String industry, String sign)
		...
		lead.clickAddRowButton1();
		log.info("Add Row Button Clicked Successfully");
		Thread.sleep(2000);
		log.info("Clicking Job Industry");
		lead.clickJobIndustryInTable();
		log.info("Job Industry Clicked Successfully");
		Thread.sleep(2000);
		log.info("Entering Job Industry");
		lead.enterIndustry(industry);
	...
	@DataProvider(name = "TG_5558_Staffing_Company_Creation_Via_TAG")
	public Object[][] data1() throws IOException, ParserConfigurationException, SAXException {
		XmlReader reader = new XmlReader();
		return reader.testData("TG_5558_Staffing_Company_Creation_Via_TAG"); // data tag from XML
	}
