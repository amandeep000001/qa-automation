...
public class TG_5352_Lead_Creation extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(TG_5352_Lead_Creation.class.getName());
	...
	@Test(dataProvider = "TG_5352_Lead_Creation")
	public void TG_5303_VerifyNewLeadFormIsOpened(String url, String username, String password, String firstName,
			String lastName, String companyName, String email, String phoneNumber, String address, String notes,
			String startDate, String endDate, String title, String sign) throws IOException, InterruptedException {
		test = extent.createTest("Verify CRM Icon and route to Lead Form");
		log.info("Logging in");
		driver.get(url);
		...
		Thread.sleep(2000);
//		log.info("Clicking Created Lead from Listing form");
//		lead.clickCreatedLead(newCompany);
//		log.info("Created Lead Clicked Successfully");
	...
	@DataProvider(name = "TG_5352_Lead_Creation")
	public Object[][] data1() throws IOException, ParserConfigurationException, SAXException {
		XmlReader reader = new XmlReader();
		return reader.testData("TG_5352_Lead_Creation"); // data tag from XML
	}
