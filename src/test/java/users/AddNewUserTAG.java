...
public class AddNewUserTAG extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(AddNewUserTAG.class.getName());
	...
	//	userList.clickFilterIcon();
		...
		Thread.sleep(10000);
		Assert.assertEquals(setPassword.verfiyPasswordSetupTagAdmin(), true, "User password is not a success");
	...
	public Object[][] data() throws IOException, ParserConfigurationException, SAXException {
		...
		return reader.testData("TG_AddNewUserTAG"); // data tag from XML
	}
