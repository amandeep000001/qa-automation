...
public class AddNewUserStaffing extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(AddNewUserStaffing.class.getName());
...
//		userList.clickClearFilterIcon();
	...
	public Object[][] data() throws IOException, ParserConfigurationException, SAXException {
		...
		return reader.testData("TG_AddNewUserStaffing"); // data tag from XML
	}
