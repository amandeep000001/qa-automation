...
public class TG_6130_RepeatDirectOrder extends TestBase {
	Functions functions;
	HomePage homePage;
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(TG_6130_RepeatDirectOrder.class.getName());
	...
	@Test(dataProvider = "TG_6130_repeat_direct_order")
	public void TG_6130_VerifyRepeatDirectOrderCreatedSuccessfully(String url, String usernameHiring,
			String passwordHiring,String staffCompany, String startDate, String enddate, String availability,
			String usernameStaffing, String passwordStaffing) throws InterruptedException {
		test = extent.createTest("TG-6130 Repeat Direct Job Order Flow");
		...
		job.clickDirectOrderCheckbox();
		test.log(Status.PASS, "Open Order Checkbox Clicked Successfully");
		
		test.log(Status.INFO, "Selecting Staffing Company");
		job.selectStaffingCompany(staffCompany);
		test.log(Status.PASS, "OStaffing Company Selected Successfully");
	...
	@DataProvider(name = "TG_6130_repeat_direct_order")
	public Object[][] data() throws IOException, ParserConfigurationException, SAXException {
		XmlReader reader = new XmlReader();
		return reader.testData("TG_6130_repeat_direct_order");
	}
