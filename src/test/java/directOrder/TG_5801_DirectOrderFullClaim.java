...
public class TG_5801_DirectOrderFullClaim extends TestBase {
	...
	public void loader() throws IOException {
		log = LogManager.getLogger(TG_5801_DirectOrderFullClaim.class.getName());
	...
	@Test(dataProvider = "TG_5801_automate_direct_order_full_claim")
...
//		test.log(Status.PASS,"Clicked on Clear Filter");
	...
	@DataProvider(name = "TG_5801_automate_direct_order_full_claim")
	public Object[][] data() throws IOException, ParserConfigurationException, SAXException {
		XmlReader reader = new XmlReader();
		return reader.testData("TG_5801_automate_direct_order_full_claim");
	}
